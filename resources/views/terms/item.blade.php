...
<div class="col-md-6 mx-auto my-5 text-muted">
  <div class="card-post py-4 my-5 px-5">
       ...
       <p class="tos">この利用規約（以下，「本規約」といいます。）は，ecopeco（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
